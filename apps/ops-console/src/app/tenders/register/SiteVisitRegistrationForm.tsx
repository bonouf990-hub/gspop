  ...
  if (submitted) {
    return (
      <div className="border border-green-700 bg-green-950/30 rounded-xl p-8 text-center">
        <p className="text-2xl font-extrabold text-green-700 mb-2">Registration Confirmed</p>
        <p className="text-[#5b6b85]">
          Thank you, {vendorName}. Your representative <strong className="text-[#16233c]">{repName}</strong> has
          been registered for the site visit. Please arrive on time at the designated meeting point.
        </p>
        <p className="text-sm text-[#8b97ab] mt-4">
