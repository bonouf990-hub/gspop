  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <div>
          <label className="text-xs text-[#5b6b85] mb-1 block">Frequency *</label>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div>
          <label className="text-xs text-[#5b6b85] mb-1 block">Asset (optional)</label>
      ...
      <div className="grid grid-cols-2 gap-2">
        <div>
          <label className="text-xs text-[#5b6b85] mb-1 block">Trade</label>
          <input className={input} placeholder="e.g. HVAC, Electrical"
            value={form.trade} onChange={(e) => setForm({ ...form, trade: e.target.value })} />
        </div>
        <div>
          <label className="text-xs text-[#5b6b85] mb-1 block">Est. Hours</label>
      ...
      <div className="grid grid-cols-2 gap-2">
        <div>
          <label className="text-xs text-[#5b6b85] mb-1 block">Technician</label>
      ...
      <div>
        <label className="text-xs text-[#5b6b85] mb-1 block">Next Due Date *</label>
