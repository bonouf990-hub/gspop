...
const STATUS_STYLE: Record<string, string> = {
  ...
  checked_out: "bg-[rgba(255,255,255,0.06)] text-[#9aa5bd]",
  declined: "bg-[rgba(180,60,60,0.15)] text-[#e08a8a]",
  expired: "bg-[rgba(255,255,255,0.06)] text-[#9aa5bd]",
};
  ...
  return (
    <main className="min-h-screen pb-32">
      <div className="px-6 pt-10 pb-6">
        ...
        <h1 className="font-display text-3xl text-[#eef1f6] font-semibold">Gate</h1>
          ...
          <ul className="space-y-3">
            {visitors.map((v) => (
              <li key={v.id} className="flex items-center justify-between pb-3 border-b border-[var(--hairline)] last:border-0 last:pb-0">
                <div>
                  <p className="text-sm font-medium text-[#eef1f6]">{v.fullName || v.brandName || "Visitor"}</p>
