  ...
  return (
    <main className="min-h-screen pb-10">
      <div className="px-6 pt-10 pb-6">
        ...
        <h1 className="font-display text-3xl text-[#16233c] font-semibold">Report an Issue</h1>
      ...
      {!categoryId ? (
              ...
              {categories.map((cat) => {
                ...
                return (
                  <button
                    ...
                    className="flex flex-col items-center gap-2 rounded-xl p-4 text-center border bg-[#f4f6fa] border-[var(--hairline)]"
                  >
                    <span className="w-10 h-10 rounded-full flex items-center justify-center bg-[rgba(176,27,66,0.12)] text-[var(--gold)]">
                      <Icon size={18} strokeWidth={1.8} />
                    </span>
                    <span className="text-xs font-medium text-[#16233c]">{cat.name}</span>
                  </button>
                );
              })}
              {categories.length === 0 && (
        ...
        <form onSubmit={handleSubmit} className="px-5 space-y-5">
          ...
          <div className="elevated-card rounded-2xl p-5 space-y-4">
            <textarea
              className="w-full bg-[#f4f6fa] border border-[var(--hairline)] rounded-xl p-3 h-28 text-sm text-[#16233c]"
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-[#f4f6fa] border border-[var(--hairline)] text-[#16233c] rounded-xl p-3 text-sm font-medium disabled:opacity-40"
          ...
          {error && <p className="text-[#c0304a] text-xs text-center">{error}</p>}
