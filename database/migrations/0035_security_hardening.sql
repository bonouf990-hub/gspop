...
-- work_order_checkins: scoped via work_orders tenant
create policy tenant_isolation_wo_checkins on work_order_checkins
  for all using (
...
-- work_order_ratings: scoped via work_orders tenant
...
-- Approvals: management + the requester only
...
-- Invoices: management only (technicians/residents cannot see)
...
-- Purchase orders: management only
